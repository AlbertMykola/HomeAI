...
final class InspirationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        config()
        loadData()
        AmplitudeService.shared.logEvent(.showInspirations)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if indexPath.section == 0 {
            ...
            retrieveImageForItem(at: indexPath) { [weak self] image in
                ...
                let option = designOption(for: categories[selectedSectionIndex].category)
                _ = NavigationManager.shared.showInspirationDetail(
                    ...
                    showsLimitedEditorActions: true
                )
            }
        }
    }
...
// MARK: - Inspiration helpers
private extension InspirationViewController {
    func designOption(for category: String) -> DesignOption {
