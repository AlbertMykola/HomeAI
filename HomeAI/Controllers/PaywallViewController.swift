...
private struct Defaults {
    ...
    struct Text {
        ...
        static let cancelAnytime = "Cancel Anytime".localized
        static let noPayment = "No payment due now".localized
        static let tryFree = "Try Free 3 days".localized
    }
}
    ...
    private func buyProduct(index: Int) {
        ...
        Task { @MainActor in
            apphud.buyProduct(index: index) { [weak self] result in
                ...
                switch result {
                case .success(let isSubscriptionActive):
